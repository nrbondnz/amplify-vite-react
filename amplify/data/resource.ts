...
import { schema as generatedSqlSchema } from "../../src/shared/models/schema.sql"

// Add a global authorization rule
const sqlSchema = generatedSqlSchema.authorization(allow => allow.guest())
/*const sqlSchema = generatedSqlSchema.renameModels(() => [
    ['location', 'Location'] // Renames the models from "notes" -> "Note"
]);*/
